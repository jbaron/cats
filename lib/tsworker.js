...
(function (Cats) {
    ...
    (function (TSWorker) {
        ...
        var ScriptInfo = (function () {
            ...
            ScriptInfo.prototype.insertDoc = function (position) {
                var text = this.ls.getDocCommentTemplateAtPosition(this.fileName, position);
                if (text)
                    TSWorker.console.log(text.newText);
            };
            /*
            ...
            */
            ...
            ScriptInfo.prototype.convertTodoNavigate = function (todos) {
                var _this = this;
             ...
             */
            ScriptInfo.prototype.getTodoItems = function () {
                var descriptors = [
