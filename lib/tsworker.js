...
(function (TSWorker) {
    ...
    var TypeScriptHint = (function () {
        ...
        TypeScriptHint.prototype.getUnitName = function (index) {
            return this.typescriptLS.scripts[index].name;
        };
        TypeScriptHint.prototype.getCursor = function (name, chars) {
        ...
        TypeScriptHint.prototype.getDefinitionAtPosition = function (fileName, pos) {
        ...
        TypeScriptHint.prototype.getRange = function (script, minChar, limChar) {
