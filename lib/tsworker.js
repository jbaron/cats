    ...
    (function (TSWorker) {
        ...
        var LanguageServiceHost = (function () {
            ...
            LanguageServiceHost.prototype.getLocalizedDiagnosticMessages = function () {
                Cats.TSWorker.console.log("Called getLocalizedDiagnosticMessages");
            };

            LanguageServiceHost.prototype.fileExists = function (path) {
                Cats.TSWorker.console.log("Called fileExist" + path);
                return true;
            };

            LanguageServiceHost.prototype.directoryExists = function (path) {
                Cats.TSWorker.console.log("Called directoryExist" + path);
                return true;
            };

            LanguageServiceHost.prototype.getParentDirectory = function (path) {
                Cats.TSWorker.console.log("Called getParentDirectory" + path);
                return "";
            };

            LanguageServiceHost.prototype.resolveRelativePath = function (path, directory) {
                Cats.TSWorker.console.log("Called resolveRelativePath" + path + " " + directory);
                return "";
            };
        ...
        */
        ...
        var ISense = (function () {
            ...
            */
            function ISense() {
                this.maxErrors = 20;
                this.lsHost = new Cats.TSWorker.LanguageServiceHost();
                ...
                for (var fileName in scripts) {
                    try  {
                        ...
                        if (fileErrors && fileErrors.length) {
                            TSWorker.console.log("errors in file " + fileName);
        ...
        addEventListener('message', function (e) {
            ...
            try  {
                ...
                TSWorker.console.log("Error during processing message " + method);
