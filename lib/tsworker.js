...
(function (TSWorker) {
    ...
    var ISense = (function () {
        ...
        ISense.prototype.structureErrors = function (errorStr) {
        ...
        ISense.prototype.updateScript = function (fileName, src, getErrors) {
            if (typeof getErrors === "undefined") { getErrors = true; }
            this.typescriptLS.updateScript(fileName, src, false);
            if(getErrors) {
                return this.getErrors(fileName);
            }
        };
