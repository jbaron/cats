        ...
        var ModelCreator = (function () {
            ...
            ModelCreator.prototype.handle = function (node) {
                ...
                try {
                    ...
                    if (node.kind === 128 /* MethodDeclaration */) {
                        if (this.last)
                    ...
                    if (node.kind === 126 /* PropertyDeclaration */) {
                        if (this.last) {
                            var attr = {
                                name: node.name["text"],
                                modifiers: [],
            ...
            ModelCreator.prototype.isTopLevelNode = function (kind) {
                return ((kind === 191 /* ClassDeclaration */) || (kind === 192 /* InterfaceDeclaration */) || (kind === 194 /* EnumDeclaration */));
            };
            ...
            ModelCreator.prototype.createIfNotExist = function (node) {
                ...
                if (!this.model[fullName]) {
                    ...
                    if (node.kind === 191 /* ClassDeclaration */) {
                        var cd = node;
                    }
