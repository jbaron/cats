    ...
    (function (TSWorker) {
        ...
        var ISense = (function () {
            ...
            ISense.prototype.getDependencyGraph = function () {
                var result = [];
                this.lsHost.scripts.forEach(function (script) {
                    var entry = {
                        src: script.name,
                        ref: []
                    };
            ...
            ISense.prototype.getScriptContent = function (name) {
                var scripts = this.lsHost.scripts;
            ...
            ISense.prototype.getErrors = function (unitName) {
                var result = [];
                var errors;
                if(unitName) {
            ...
            ISense.prototype.updateScript = function (unitName, src, resident) {
            ...
            ISense.prototype.getScriptLexicalStructure = function (unitName) {
                var results = this.ls.getScriptLexicalStructure(unitName);
                return this.convertNavigateTo(results);
            };
            ISense.prototype.getOutliningRegions = function (unitName) {
