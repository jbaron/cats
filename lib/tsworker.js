...
(function (Cats) {
    (function (TSWorker) {
        ...
        */
        TSWorker.console = {
            log: function (str) {
                postMessage({ level: "log", msg: str }, null);
            },
            error: function (str) {
                postMessage({ level: "error", msg: str }, null);
            },
            info: function (str) {
                postMessage({ level: "info", msg: str }, null);
            }
        };
        ...
        var ISense = (function () {
            ...
            */
            ISense.prototype.compile = function () {
                ...
                TSWorker.console.error("Errors found: " + errors.length);
                return {
                    source: result,
                    errors: errors
                };
