...
(function (cats) {
    ...
    var Session = (function () {
        ...
        Session.prototype.getCursorFromScreen = function (x, y) {
        ...
        Session.prototype.getScreenPos = function (x, y) {
    ...
    var Project = (function () {
        ...
        Project.prototype.onMouseMove = function (ev) {
            ...
            this.mouseMoveTimer = setTimeout(function () {
                _this.session.getScreenPos(ev.x, ev.y);
            }, 100);
        };
...
(function (menu) {
    ...
    function createContextMenu() {
        ...
        ctxmenu.append(new gui.MenuItem({
            ...
            click: function () {
                getInfoAt("getDefinitionAtPosition");
            }
        }));
        ctxmenu.append(new gui.MenuItem({
