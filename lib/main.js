...
(function (cats) {
    ...
    var Session = (function () {
        ...
        Session.prototype.showInfoAt = function (ev) {
            ...
            project.iSense.perform("getInfoAtPosition", "getTypeAtPosition", this.name, docPos, function (err, data) {
                if(!data) {
                    return;
                }
    ...
    var EditorContextMenu = (function () {
        function EditorContextMenu(project) {
            ...
            this.ctxmenu.append(new gui.MenuItem({
                ...
                click: function () {
                    _this.getInfoAt("getReferencesAtPosition");
                }
            }));
            this.ctxmenu.append(new gui.MenuItem({
                label: 'Get Occurences',
                click: function () {
                    _this.getInfoAt("getOccurrencesAtPosition");
                }
            }));
            this.ctxmenu.append(new gui.MenuItem({
                label: 'Get Implementors',
                click: function () {
                    _this.getInfoAt("getImplementorsAtPosition");
                }
            }));
        }
        ...
        EditorContextMenu.prototype.getCursor = function () {
        ...
        EditorContextMenu.prototype.gotoDeclaration = function () {
        ...
        EditorContextMenu.prototype.getInfoAt = function (type) {
            var cursor = this.getCursor();
            var fileName = cats.project.session.name;
...
(function (Menu) {
    ...
    var Menubar = (function () {
        ...
        Menubar.prototype.formatText = function () {
            ...
            cats.project.iSense.perform("getFormattingEditsForRange", session.name, 0, session.getValue().length, function (err, result) {
                console.log(result);
            });
        };
