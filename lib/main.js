    ...
    (function (Gui) {
        ...
        var SourceEditor = (function (_super) {
            ...
            SourceEditor.prototype.createEditSession = function () {
                var _this = this;
                this.editSession = new Gui.EditSession(this);
             ...
             */
            SourceEditor.prototype.configureModeSupport = function () {
                var _this = this;
                if (this.isTypeScript()) {
    ...
    (function (Gui) {
        ...
        var EditSession = (function (_super) {
            ...
            EditSession.prototype.save = function () {
                ...
                Cats.OS.File.writeTextFile(filePath, this.getValue());
                this.editor.setHasUnsavedChanges(false);
                this.editor.updateFileInfo();
                Cats.IDE.console.log("Saved file " + filePath);
                if (this.isTypeScript()) {
                    Cats.IDE.project.iSense.updateScript(filePath, this.getValue());
