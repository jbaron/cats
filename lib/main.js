...
(function (Cats) {
    var Project = (function () {
        ...
        Project.prototype.refresh = function () {
            ...
            var srcPaths = [].concat(this.config.srcPath);
    ...
    (function (Commands) {
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function init(registry) {
                ...
                registry({
                    name: Commands.CMDS.project_dependencies,
                    label: "Show Dependencies",
                    command: showDependency
                });
            };
    ...
    (function (Commands) {
        ...
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function init(registry) {
                ...
                registry({
                    name: Commands.CMDS.ide_toggleView,
                    label: "Toggle View",
                    command: toggleView
                });
            };
...
(function (Cats) {
    (function (Commands) {
        (function (CMDS) {
            ...
            CMDS._map[38] = "project_dependencies";
            CMDS.project_dependencies = 38;
            CMDS._map[39] = "navigate_references";
            CMDS.navigate_references = 39;
            CMDS._map[40] = "navigate_occurences";
            CMDS.navigate_occurences = 40;
            CMDS._map[41] = "navigate_implementors";
            CMDS.navigate_implementors = 41;
            CMDS._map[42] = "navigate_declaration";
            CMDS.navigate_declaration = 42;
            CMDS._map[43] = "refactor_rename";
            CMDS.refactor_rename = 43;
            CMDS._map[44] = "ide_quit";
            CMDS.ide_quit = 44;
            CMDS._map[45] = "ide_theme";
            CMDS.ide_theme = 45;
            CMDS._map[46] = "ide_fontSize";
            CMDS.ide_fontSize = 46;
            CMDS._map[47] = "ide_toggleView";
            CMDS.ide_toggleView = 47;
