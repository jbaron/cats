    ...
    (function (Commands) {
        ...
        var EditorCommands = (function () {
            ...
            EditorCommands.init = function (registry) {
                ...
                registry({ name: 22 /* edit_toggleInvisibles */, label: "Toggle Invisible Characters", command: toggleInvisibles, icon: "static/img/invisibles.png" });
                registry({ name: 28 /* source_format */, label: "Format Code", command: formatText, icon: "static/img/format.png" });
            };
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                registry({ name: 32 /* project_open */, label: "Open Project...", command: openProject, icon: "static/img/open.png" });
                registry({ name: 33 /* project_close */, label: "Close project", command: closeProject });
                registry({ name: 34 /* project_build */, label: "Build Project", command: buildProject, icon: "static/img/build.png" });
                registry({ name: 35 /* project_validate */, label: "Validate Project", command: validateProject });
                registry({ name: 38 /* project_refresh */, label: "Refresh Project", command: refreshProject, icon: "static/img/refresh.png" });
                registry({ name: 36 /* project_run */, label: "Run Project", command: runProject, icon: "static/img/run.png" });
