        ...
        */
        Ide.prototype.configure = function () {
            ...
            if (config.theme) {
                ...
                if (theme)
                    qx.theme.manager.Meta.getInstance().setTheme(this.themes[theme]);
            }
        };
    ...
    (function (Commands) {
        ...
        */
        (function (CMDS) {
            ...
            CMDS[CMDS["project_document"] = 44] = "project_document";

            CMDS[CMDS["refactor_rename"] = 45] = "refactor_rename";

            CMDS[CMDS["ide_quit"] = 46] = "ide_quit";
            CMDS[CMDS["ide_theme"] = 47] = "ide_theme";
            CMDS[CMDS["ide_fontSize"] = 48] = "ide_fontSize";
            CMDS[CMDS["ide_rightMargin"] = 49] = "ide_rightMargin";
            CMDS[CMDS["ide_toggleView"] = 50] = "ide_toggleView";
            CMDS[CMDS["ide_configure"] = 51] = "ide_configure";
        ...
        */
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                registry({ name: 46 /* ide_quit */, label: "Quit", command: quit });
                registry({ name: 50 /* ide_toggleView */, label: "Toggle View", command: toggleView });
                registry({ name: 51 /* ide_configure */, label: "Settings", command: configureIde });
            };
            return IdeCommands;
        })();
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                ...
                registry({ name: 44 /* project_document */, label: "Generate Documentation", command: documentProject });
            };
    ...
    (function (Commands) {
        ...
        var RefactorCommands = (function () {
            ...
            RefactorCommands.init = function (registry) {
                registry({ name: 45 /* refactor_rename */, label: "Rename", command: rename });
            };
        ...
        */
        var Menubar = (function () {
            function Menubar() {
                ...
                file.append(new GUI.MenuItem({ type: "separator" }));
                file.append(getCmd(51 /* ide_configure */));
                file.append(getCmd(46 /* ide_quit */));
                ...
                proj.append(getCmd(44 /* project_document */));
                proj.append(getCmd(38 /* project_run */));
            ...
            */
            ...
            Menubar.prototype.createViewMenu = function () {
                ...
                views.forEach(function (view) {
                    var item = _this.getMenuCommand(50 /* ide_toggleView */, view.name, view.id);
                    menu.append(item);
                });
                return menu;
            };
            ...
            win.addListenerOnce("ready", function () {
                try  {
                    ...
                    if (_this.config.documentation.readme && (_this.config.documentation.readme !== "none")) {
                        readme = PATH.join(_this.projectDir, _this.config.documentation.readme);
                    }
                    ...
                    var dest = path.join(_this.projectDir, outputDir);
        ...
        */
        Project.prototype.loadTypeScriptFiles = function (pattern) {
            ...
            OS.File.find(pattern, this.projectDir, function (err, files) {
                files.forEach(function (file) {
                    try  {
                        var fullName = OS.File.switchToForwardSlashes(path.join(_this.projectDir, file));
