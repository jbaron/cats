...
(function (Cats) {
    ...
    var ConfigLoader = (function () {
        ...
        ConfigLoader.NAME = ".settings" + path.sep + "config.json";
        ...
        var TreeView = (function () {
            function TreeView() {
                ...
                this.rootElem.onclick = function (ev) {
                    ev.stopPropagation();
                    _this.handleClick(ev.srcElement);
                };
            }
            ...
            TreeView.prototype.render = function (list) {
                ...
                list.forEach(function (entry) {
                    ...
                    li.innerText = _this.getValue(entry, "name");
                    li["_value"] = entry;
...
(function (Cats) {
    ...
    if(args && (args.length > 0)) {
        ...
        Cats.project = new Cats.Project(args[0]);
    } else {
