    ...
    (function (Commands) {
        ...
        var EditorCommands = (function () {
            ...
            EditorCommands.init = function (registry) {
                ...
                registry({ name: Commands.CMDS.source_format, label: "Format Code", command: formatText });
            };
        ...
        */
        ...
        var FileCommands = (function () {
            ...
            FileCommands.init = function (registry) {
                registry({ name: Commands.CMDS.file_new, label: "New File", command: newFile });
                registry({ name: Commands.CMDS.file_close, label: "Close File", command: closeFile });
                registry({ name: Commands.CMDS.file_closeOther, label: "Close Other Files", command: closeOtherFiles });
                registry({ name: Commands.CMDS.file_closeAll, label: "Close All Files", command: closeAllFiles });
                registry({ name: Commands.CMDS.file_save, label: "Save File", icon: "static/img/save_edit.gif", command: saveFile });
                registry({ name: Commands.CMDS.file_saveAll, label: "Save All", icon: "static/img/saveall_edit.gif", command: saveAll });
                registry({ name: Commands.CMDS.file_saveAs, label: "Save As...", icon: "static/img/saveas_edit.gif", command: saveAs });
            };
            return FileCommands;
        })();
        ...
        */
        ...
        var HelpCommands = (function () {
            ...
            HelpCommands.init = function (registry) {
                registry({ name: Commands.CMDS.help_about, label: "About", command: showAbout });
                registry({ name: Commands.CMDS.help_devTools, label: "Developer Tools", command: showDevTools });
                registry({ name: Commands.CMDS.help_shortcuts, label: "Shortcuts", command: showShortcuts });
                registry({ name: Commands.CMDS.help_processInfo, label: "Process Info", command: showProcess });
            };
            return HelpCommands;
        })();
        ...
        */
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                registry({ name: Commands.CMDS.ide_quit, label: "Quit", command: quit });
                registry({ name: Commands.CMDS.ide_theme, label: "Theme", command: setTheme });
                registry({ name: Commands.CMDS.ide_fontSize, label: "Font Size", command: setFontSize });
                registry({ name: Commands.CMDS.ide_toggleView, label: "Toggle View", command: toggleView });
            };
            return IdeCommands;
        })();
    ...
    (function (Commands) {
        ...
        var NavigateCommands = (function () {
            ...
            NavigateCommands.init = function (registry) {
                registry({ name: Commands.CMDS.navigate_references, label: "Find References", command: findReferences });
                registry({ name: Commands.CMDS.navigate_implementors, label: "Find Implementations", command: findImplementors });
                registry({ name: Commands.CMDS.navigate_occurences, label: "Find Occurences", command: findOccurences });
                registry({ name: Commands.CMDS.navigate_declaration, label: "Goto Declaration", command: gotoDeclaration });
            };
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                registry({ name: Commands.CMDS.project_open, label: "Open Project...", command: openProject });
                registry({ name: Commands.CMDS.project_close, label: "Close project", command: closeProject });
                registry({ name: Commands.CMDS.project_build, label: "Build Project", command: buildProject });
                registry({ name: Commands.CMDS.project_validate, label: "Validate Project", command: validateProject });
                registry({ name: Commands.CMDS.project_refresh, label: "Refresh Project", command: refreshProject });
                registry({ name: Commands.CMDS.project_run, label: "Run Project", command: runProject });
                registry({ name: Commands.CMDS.project_debug, label: "Debug Project", command: null });
                registry({ name: Commands.CMDS.project_properties, label: "Properties", command: propertiesProject });
                registry({ name: Commands.CMDS.project_dependencies, label: "Show Dependencies", command: showDependency });
            };
    ...
    (function (Commands) {
        ...
        var RefactorCommands = (function () {
            ...
            RefactorCommands.init = function (registry) {
                registry({ name: Commands.CMDS.refactor_rename, label: "Rename", command: rename });
            };
        ...
        */
        var AutoCompleteView = (function () {
            ...
            */
            ...
            AutoCompleteView.isJsIdentifierPart = /**
