...
(function (Cats) {
    ...
    var Ide = (function (_super) {
        ...
        Ide.prototype.getProject = function (path) {
        ...
        Ide.prototype.addProject = function (projectDir) {
            ...
            this.settings = new Cats.ProjectSettings(projectDir);
            this.settings.load();
...
(function (Cats) {
    ...
    var Project = (function (_super) {
        ...
        function Project(tsConfigFile) {
            ...
            this.tsfiles = [];
            var dir = Cats.OS.File.PATH.dirname(tsConfigFile);
            dir = Cats.OS.File.PATH.resolve(dir);
        ...
        Project.prototype.refresh = function () {
            ...
            Cats.IDE.console.log("Found TypeScript project at " + this.projectDir + " containing " + this.config.files.length + " files");
            ...
            var path = Cats.OS.File.join(this.projectDir, "tsconfig.json");
        ...
        */
        Project.prototype.loadTypeScriptFiles = function () {
            var _this = this;
        ...
        Linter.prototype.lint = function (fileName, content) {
            ...
            failures.forEach(function (failure) {
                var item = {
                    ...
                    range: _this.convertPos(failure)
                };
                r.push(item);
            });
            return r;
...
(function (Cats) {
    ...
    (function (Commands) {
        ...
        function refreshProject() {
            Cats.IDE.projects.forEach(function (project) { return project.refresh(); });
        }
        /**
        ...
        (function (Editor) {
            ...
            var SourceEditor = (function (_super) {
                ...
                function SourceEditor(fileName) {
                    ...
                    this.project = Cats.IDE.getProject(fileName);
                ...
                SourceEditor.prototype.createEditSession = function () {
                    var _this = this;
                    this.editSession = new Editor.EditSession(this, this.project);
    ...
    (function (Gui) {
        ...
        (function (Editor) {
            ...
            var UMLEditor = (function (_super) {
                ...
                UMLEditor.prototype.render = function (container, project) {
                    var _this = this;
                    if (project === void 0) { project = Cats.IDE.projects[0]; }
                    var nodes = {};
    ...
    (function (Gui) {
        ...
        (function (Editor) {
            ...
            var EditSession = (function (_super) {
                ...
                function EditSession(editor, project) {
                    var _this = this;
                    // @TODO solve nicely
                ...
                EditSession.prototype.checkIfNewTSFile = function (filePath, content) {
                    var _this = this;
                    if (this.isTypeScript() && this.project && (!this.project.hasScriptFile(filePath))) {
                        ...
                        addDialog.onConfirm = function () {
                            _this.project.addScript(filePath, content);
                        };
                        addDialog.show();
                    }
                };
                ...
                EditSession.prototype.save = function () {
                    ...
                    if (filePath == null) {
                        ...
                        dialog.onSuccess = function (filePath) {
                            ...
                            if (_this.isTypeScript() && _this.project && (!_this.project.hasScriptFile(filePath))) {
                                var addDialog = new Gui.ConfirmDialog("Not yet part of project, add it now?");
                                addDialog.onConfirm = function () {
                                    _this.project.addScript(filePath, content);
                                };
        ...
        var ProjectCompilerSettings = (function (_super) {
            ...
            function ProjectCompilerSettings() {
                ...
                this.moduleGenTarget = [
                    ...
                    { label: "umd", model: 3 /* UMD */ },
                    { label: "system", model: 4 /* System */ },
                    { label: "es6", model: 5 /* ES6 */ },
                    { label: "es2015", model: 5 /* ES2015 */ }
                ];
                this.jsTarget = [
                    { label: "es3", model: 0 /* ES3 */ },
                    { label: "es5", model: 1 /* ES5 */ },
                    { label: "es6", model: 2 /* ES6 */ },
                    { label: "es2015", model: 2 /* ES2015 */ },
                    { label: "latest", model: 2 /* Latest */ }
                ];
                this.newLineKind = [
                    { label: "OSX/Linux", model: 1 /* LineFeed */ },
                    { label: "Windows", model: 0 /* CarriageReturnLineFeed */ },
                ];
                this.jsxEmit = [
                    { label: "None", model: 0 /* None */ },
                    { label: "Preserve (jsx)", model: 1 /* Preserve */ },
                    { label: "Generate React code (js)", model: 2 /* React */ }
                ];
                this.createForm();
                this.finalStep();
            }
