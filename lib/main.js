...
(function (Cats) {
    ...
    var Ide = (function (_super) {
        ...
        Ide.prototype.addProject = function (projectDir) {
            ...
            var configs = glob.sync(projectDir + "/" + "**/tsconfig.json");
...
(function (Cats) {
    ...
    var Project = (function (_super) {
        ...
        function Project(configFile) {
            ...
            _super.call(this);
            this.tsfiles = [];
            this.config = tsconfig.readFileSync(configFile);
            var dir = Cats.OS.File.PATH.dirname(configFile);
            dir = Cats.OS.File.PATH.resolve(dir);
            this.projectDir = Cats.OS.File.switchToForwardSlashes(dir);
            Cats.IDE.console.log("Open project " + this.projectDir + " files " + this.config.files.length);
            this.tsfiles = this.config.files;
            this.name = Cats.OS.File.PATH.basename(this.projectDir);
            this.refresh();
        ...
        (function (Editor) {
            ...
            var EditSession = (function (_super) {
                ...
                function EditSession(editor, project) {
                    ...
                    // @TODO
                    project.on("config", function (c) { _this.configureAceSession(c); });
                ...
                EditSession.prototype.save = function () {
                    ...
                    if (filePath == null) {
                        ...
                        dialog.onSuccess = function (filePath) {
                            ...
                            if (_this.isTypeScript() && (!_this.project.hasScriptFile(filePath))) {
                                var addDialog = new Gui.ConfirmDialog("Not yet part of project, add it now?");
                                addDialog.onConfirm = function () {
                                    _this.project.addScript(filePath, content);
                                };
