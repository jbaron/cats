...
(function (Cats) {
    ...
    class Ide extends qx.event.Emitter {
         ...
         */
        setProjectDirectory(projectDir, refreshFileNavigator = true) {
            this.projects = [];
    ...
    (function (Commands) {
        ...
        class EditorCommands {
            static init(registry) {
                ...
                registry(Commands.CMDS.edit_cut, () => { document.execCommand("cut"); });
                registry(Commands.CMDS.edit_copy, () => { document.execCommand("copy"); });
                registry(Commands.CMDS.edit_paste, () => { document.execCommand("paste"); });
            }
        }
    ...
    (function (Commands) {
        ...
        class IdeCommands {
            static init(registry) {
                ...
                registry(Commands.CMDS.ide_toggle_toolbar, () => toggleView(Cats.IDE.toolBar));
                registry(Commands.CMDS.ide_toggle_statusbar, () => toggleView(Cats.IDE.statusBar));
                registry(Commands.CMDS.ide_toggle_result, () => toggleView(Cats.IDE.resultPane));
                registry(Commands.CMDS.ide_toggle_context, () => toggleView(Cats.IDE.contextPane));
        ...
        class FileNavigator extends qx.ui.tree.VirtualTree {
            ...
            setupDragAndDrop() {
                ...
                this.addListener("drop", (e) => {
                    ...
                    console.log(orig);
                    for (var i = 0, l = sel.getLength(); i < l; i++) {
        ...
        class MenuBar {
            ...
            recentProjects() {
                ...
                Cats.IDE.config.projects.slice().reverse().forEach((project) => {
                    ...
                    var item = {
                        label: project,
                        click: () => { Cats.IDE.setProjectDirectory(project); }
                    };
