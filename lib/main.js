        ...
        */
        ...
        var FileCommands = (function () {
            ...
            FileCommands.init = function (registry) {
                registry({ name: 4 /* file_new */, label: "New File", command: newFile, icon: "newfile_cmd.gif" });
                ...
                registry({ name: 9 /* file_save */, label: "Save File", command: saveFile, icon: "save_edit_cmd.gif" });
                registry({ name: 11 /* file_saveAll */, label: "Save All", command: saveAll, icon: "saveall_edit_cmd.gif" });
                registry({ name: 10 /* file_saveAs */, label: "Save As...", command: saveAs, icon: "saveas_edit_cmd.gif" });
            };
            return FileCommands;
        })();
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                ...
                registry({ name: 34 /* project_build */, label: "Build Project", command: buildProject, icon: "build_cmd.gif" });
                registry({ name: 35 /* project_validate */, label: "Validate Project", command: validateProject });
                registry({ name: 38 /* project_refresh */, label: "Refresh Project", command: refreshProject, icon: "refresh_cmd.gif" });
                registry({ name: 36 /* project_run */, label: "Run Project", command: runProject, icon: "run_cmd.gif" });
...
var FileContextMenu = (function (_super) {
    ...
    FileContextMenu.prototype.getSelection = function () {
        return this.fileNavigator.getSelection();
    };

    FileContextMenu.prototype.getSelectedFile = function () {
        var item = this.getSelection().getItem(0);
        if (!item)
            return null;
        if (!item.getDirectory)
