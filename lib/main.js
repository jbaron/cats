    ...
    (function (Commands) {
        ...
        */
        (function (CMDS) {
            ...
            CMDS[CMDS["project_configCompilerSettings"] = 43] = "project_configCompilerSettings";
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                ...
                registry({ name: 43 /* project_configCompilerSettings */, label: "Configure Settings", command: configCompilerSettings });
            };
        ...
        */
        var Menubar = (function () {
            function Menubar() {
                ...
                proj.append(new GUI.MenuItem({ type: "separator" }));
                proj.append(getCmd(43 /* project_configCompilerSettings */));
...
var ConfigDialog = (function (_super) {
    ...
    ConfigDialog.prototype.addCheckBox = function (label, model) {
        var cb = new qx.ui.form.CheckBox();
        this.form.add(cb, label, null, model);
    };

    ConfigDialog.prototype.addSpinner = function (label, model, min, max) {
        var s = new qx.ui.form.Spinner();
        s.set({ minimum: min, maximum: max });
        this.form.add(s, label, null, model);
    };

    ConfigDialog.prototype.addTextField = function (label, model) {
        var t = new qx.ui.form.TextField();
        this.form.add(t, label, null, model);
    };

    ConfigDialog.prototype.setData = function (data) {
        for (var key in data) {
            try  {
    ...
    ConfigDialog.prototype.finalStep = function () {
...
var ConfigCompilerSettings = (function (_super) {
    ...
    function ConfigCompilerSettings() {
        _super.call(this, "Compiler Settings");
        this.createForm();
        this.finalStep();
    }
...
var CustomBuildSettings = (function (_super) {
    ...
    function CustomBuildSettings(name) {
        if (typeof name === "undefined") { name = "Settings"; }
        _super.call(this, name);
        this.createForm();
        this.finalStep();
    }
...
var CustomRunSettings = (function (_super) {
    ...
    CustomRunSettings.prototype.createForm = function () {
