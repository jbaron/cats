...
(function (Cats) {
    (function (Gui) {
        ...
        var Completer = (function () {
            ...
            Completer.prototype.getCompletions = function (editor, session, pos, prefix, cb) {
                ...
                IDE.project.iSense.getCompletions(fileName, pos, function (err, completes) {
                    ...
                    if (!completes)
                        return result;
                    completes.entries.forEach(function (entry) {
