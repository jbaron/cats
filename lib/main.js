            ...
            Outline.prototype.initOutlineView = function () {
                ...
                IDE.on("activeSession", function (session) {
                    if (session && (session.mode === "typescript"))
                        _this.handleOutlineEvent(session); else
                        IDE.outlineNavigation.innerHTML = "";
                });
            };
            return Outline;
    ...
    (function (UI) {
        ...
        var TreeView = (function () {
            ...
            TreeView.prototype.refresh = function () {
                ...
                this.findOpenFolders().forEach(function (path) {
...
(function (Cats) {
    ...
    function initNavBar() {
        ...
        var t = new Cats.UI.ElemTabAdapter(navbar, [IDE.fileNavigation, IDE.outlineNavigation], IDE.fileNavigation);
...
(function (Cats) {
    (function (Commands) {
        (function (CMDS) {
            ...
            CMDS[CMDS["project_run"] = 34] = "project_run";
            CMDS[CMDS["project_debug"] = 35] = "project_debug";
            CMDS[CMDS["project_refresh"] = 36] = "project_refresh";
            CMDS[CMDS["project_properties"] = 37] = "project_properties";
            CMDS[CMDS["project_dependencies"] = 38] = "project_dependencies";

            CMDS[CMDS["navigate_references"] = 39] = "navigate_references";
            CMDS[CMDS["navigate_occurences"] = 40] = "navigate_occurences";
            CMDS[CMDS["navigate_implementors"] = 41] = "navigate_implementors";
            CMDS[CMDS["navigate_declaration"] = 42] = "navigate_declaration";

            CMDS[CMDS["refactor_rename"] = 43] = "refactor_rename";
    ...
    (function (UI) {
        ...
        var AutoCompleteView = (function () {
            ...
            AutoCompleteView.prototype.current = function () {
                if (this.cursor >= 0)
                    return this.listElement.childNodes[this.cursor]; else
                    return null;
            };
