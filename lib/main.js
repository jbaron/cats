        ...
        Project.prototype.document = function () {
            ...
            win.addListenerOnce("ready", function () {
                try {
                    ...
                    app.generate(Object.keys(_this.tsfiles), dest);
                }
                finally {
                    win.hide();
                }
...
(function (Cats) {
    ...
    (function (Gui) {
        ...
        Gui.getCompleters = getCompleters;
    ...
    (function (Gui) {
        ...
        var AutoCompletePopup = (function (_super) {
            ...
            AutoCompletePopup.prototype.complete = function (memberCompletionOnly, sourceEditor, editor) {
                ...
                var matches = [];
                var completers = Gui.getCompleters(sourceEditor, memberCompletionOnly);
