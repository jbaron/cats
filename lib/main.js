...
(function (Cats) {
    (function (UI) {
        var Widget = (function () {
            ...
            Widget.prototype.setAspect = function (name, aspect) {
        ...
        var Tree = (function (_super) {
            ...
            Tree.prototype.render = function () {
                ...
                list.forEach(function (entry) {
                    ...
                    treeNode.render();
                    treeNode.appendTo(_this.rootElem);
                });
            };
...
(function (Cats) {
    ...
    Cats.JSSense;
    function initIDE() {
        Cats.JSSense = new Cats.ISenseHandler();
        var libdts = FS.readFileSync("typings/lib.d.ts", "utf8");
        var fullName = PATH.join(process.cwd(), "typings/lib.d.ts");
        Cats.JSSense.perform("addScript", fullName, libdts, true, null);
    }
    Cats.initIDE = initIDE;
})(Cats || (Cats = {}));
var Cats;
(function (Cats) {
    (function (Menu) {
...
(function (Cats) {
    var ConfigLoader = (function () {
        ...
        ConfigLoader.NAME = ".settings" + "/" + "config.json";
...
(function (Cats) {
    var Project = (function () {
        ...
        Project.prototype.getConfigFileName = function () {
            return PATH.join(this.projectDir, Cats.ConfigLoader.NAME);
        };
                ...
                try  {
                    ...
                    if(stats.isFile()) {
                        ...
                        if(ext === ".ts") {
                            ...
                            _this.iSense.perform("updateScript", fullName, content, null);
