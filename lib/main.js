...
(function (Cats) {
    var Ide = (function (_super) {
        ...
        Ide.prototype.addProject = function (dir) {
            this.project = new Cats.Project(dir);
        };
        return Ide;
    })(Cats.ObservableImpl);
    Cats.Ide = Ide;    
...
(function (Cats) {
    (function (Commands) {
        ...
        function buildProject() {
            ...
            project.iSense.perform("compile", function (err, data) {
        ...
        function propertiesProject() {
            ...
            var session = IDE.openSession(Cats.ConfigLoader.getFileName(project.projectDir));
...
(function (Cats) {
    var ISenseHandler = (function () {
        ...
        ISenseHandler.prototype.updateScript = function (unitName, content) {
...
(function (Cats) {
    ...
    var Session = (function (_super) {
        ...
        Session.prototype.setListeners = function () {
            var _this = this;
            var listeners = {
        ...
        var SessionsBar = (function (_super) {
            ...
            SessionsBar.prototype.renderDropDown = function () {
                ...
                IDE.sessions.forEach(function (session) {
                    ...
                    if(session === IDE.mainEditor.activeSession) {
