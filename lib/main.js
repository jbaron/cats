        ...
        var SourceEditor = (function (_super) {
            ...
            function SourceEditor(fileName) {
                ...
                this.editSession.on("changeAnnotation", function () {
                    ...
                    _this.emit("errors", _this.getMaxAnnotation(a));
                });
            ...
            */
            SourceEditor.prototype.getMaxAnnotation = function (annotations) {
            ...
            *
            */
            SourceEditor.prototype.updateOutline = function (timeout) {
                var _this = this;
                if (typeof timeout === "undefined") { timeout = 5000; }
                if (!this.isTypeScript())
                    return;
                clearTimeout(this.outlineTimer);
                this.outlineTimer = setTimeout(function () {
                    _this.project.iSense.getScriptLexicalStructure(_this.filePath, function (err, data) {
                        _this.set("outline", data);
                    });
                }, timeout);
            };
