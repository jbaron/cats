        ...
        */
        Project.prototype.refresh = function () {
            ...
            if (this.config.compiler.outFileOption) {
                this.config.compiler.outFileOption = Cats.OS.File.join(this.projectDir, this.config.compiler.outFileOption);
        ...
        */
        function rename(session, pos) {
            ...
            session.project.iSense.getTypeAtPosition(session.name, pos, function (err, data) {
                ...
                if (!newName)
                    return;
                _this.session.project.iSense.getInfoAtPosition("getReferencesAtPosition", session.name, pos, function (err, data) {
...
(function (Cats) {
    ...
    */
    var SessionHistory = (function () {
        ...
        SessionHistory.prototype.add = function (entry) {
            this.entries.push({
    ...
    (function (Gui) {
        ...
        */
        var OutlineNavigator = (function (_super) {
            ...
            OutlineNavigator.prototype.expandAll = function () {
        ...
        var SourceEditor = (function (_super) {
            ...
            function SourceEditor(session) {
                ...
                this.addListenerOnce("appear", function () {
                    ...
                    setTimeout(function () {
                        _this.fireDataEvent("ready", _this);
                    }, 10);
                }, this);
            ...
            UMLEditor.prototype.render = function (container) {
                ...
                IDE.project.iSense.getObjectModel(function (err, model) {
                    ...
                    model.forEach(function (entry) {
                        ...
                        entry.attributes.forEach(function (aName) {
        ...
        */
        var TabView = (function (_super) {
            ...
            function TabView(tabNames) {
                if (typeof tabNames === "undefined") { tabNames = []; }
                var _this = this;
                _super.call(this);
        ...
        */
        ...
        var SessionTabView = (function (_super) {
            ...
            SessionTabView.prototype.addSession = function (session, pos) {
                ...
                if (pos) {
                    page.editor.addListenerOnce("ready", function (editor) {
            ...
            */
            ...
            SessionTabView.prototype.navigateToPage = function (page, pos) {
                this.setSelection([page]);
                if (pos)
                    page.editor.moveToPosition(pos);
            };
        ...
        var Layout = (function () {
            ...
            */
            Layout.prototype.layout = function (ide) {
                ...
                // ********************* Navigator Pane ********************
                var navigatorPane = new Gui.TabView(["files", "bookmarks"]);
                ...
                ide.infoPane = new Gui.TabView(["outline", "properties"]);
    ...
    (function (Gui) {
        ...
        */
        var SearchDialog = (function (_super) {
            ...
            SearchDialog.prototype.getResults = function (content, pattern, fileName, result) {
                    ...
                    files.forEach(function (file) {
                        ...
                        try  {
                            ...
                            if (content.match(searchPattern)) {
                                _this.getResults(content, searchPattern, fullName, result);
                            }
                        } catch (err) {
                            console.error("Got error while handling file " + fullName);
                            console.error(err);
