    ...
    (function (Gui) {
        ...
        var SourceEditor = (function (_super) {
            ...
            function SourceEditor(fileName) {
                ...
                this.contextMenu = new Gui.SourceEditorContextMenu(this);
                this.createWidget();
            ...
            SourceEditor.prototype.createEditSession = function (fileName) {
                var _this = this;
                var content = "";
                ...
                this.editSession.on("changeAnnotation", function () {
                    _this.emit("errors", _this.editSession.getMaxAnnotation());
                });
             ...
             */
            SourceEditor.prototype.configureMode = function () {
                var _this = this;
                ...
                if (this.isTypeScript()) {
                    ...
                    if (isProjectFile) {
                        this.aceEditor.completers = [new Gui.TSCompleter(this), Gui.snippetCompleter];
                        this.aceEditor.commands.on('afterExec', function (e) {
                    ...
                    this.aceEditor.completers = [Gui.keyWordCompleter, Gui.snippetCompleter];
                }
            };
            /**
            ...
            SourceEditor.prototype.save = function () {
                if (this.filePath == null) {
                    ...
                    this.label = Cats.OS.File.PATH.basename(this.filePath);
                    Cats.IDE.editorTabView.getPageForEditor(this).setLabel(this.label);
                }
...
(function (Cats) {
    ...
    (function (Gui) {
        ...
        var EditSession = (function (_super) {
             ...
             */
            EditSession.prototype.getMaxAnnotation = function () {
