    ...
    (function (Commands) {
        ...
        var EditorCommands = (function () {
            ...
            EditorCommands.init = function (registry) {
                ...
                registry({ name: Commands.CMDS.source_format, command: formatText });
                registry({ name: Commands.CMDS.edit_cut, command: function () {
                    document.execCommand("cut");
                } });
                registry({ name: Commands.CMDS.edit_copy, command: function () {
                    document.execCommand("copy");
                } });
                registry({ name: Commands.CMDS.edit_paste, command: function () {
    ...
    (function (Commands) {
        ...
        var FileCommands = (function () {
            ...
            FileCommands.init = function (registry) {
                registry({ name: Commands.CMDS.file_new, command: newFile });
                registry({ name: Commands.CMDS.file_close, command: closeFile });
                registry({ name: Commands.CMDS.file_closeOther, command: closeOtherFiles });
                registry({ name: Commands.CMDS.file_closeAll, command: closeAllFiles });
                registry({ name: Commands.CMDS.file_save, command: saveFile });
                registry({ name: Commands.CMDS.file_saveAll, command: saveAll });
                registry({ name: Commands.CMDS.file_saveAs, command: saveAs });
            };
            return FileCommands;
        })();
    ...
    (function (Commands) {
        ...
        var HelpCommands = (function () {
            ...
            HelpCommands.init = function (registry) {
                registry({ name: Commands.CMDS.help_about, command: showAbout });
                registry({ name: Commands.CMDS.help_devTools, command: showDevTools });
                registry({ name: Commands.CMDS.help_shortcuts, command: showShortcuts });
                registry({ name: Commands.CMDS.help_processInfo, command: showProcess });
            };
            return HelpCommands;
        })();
    ...
    (function (Commands) {
        ...
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                registry({ name: Commands.CMDS.ide_quit, command: quit });
                registry({ name: Commands.CMDS.ide_toggleView, command: toggleView });
                registry({ name: Commands.CMDS.ide_configure, command: configureIde });
                registry({ name: Commands.CMDS.ide_history_next, command: next });
                registry({ name: Commands.CMDS.ide_history_prev, command: prev });
            };
            return IdeCommands;
        })();
    ...
    (function (Commands) {
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                registry({ name: Commands.CMDS.project_open, command: openProject });
                registry({ name: Commands.CMDS.project_close, command: closeProject });
                registry({ name: Commands.CMDS.project_build, command: buildProject });
                registry({ name: Commands.CMDS.project_validate, command: validateProject });
                registry({ name: Commands.CMDS.project_refresh, command: refreshProject });
                registry({ name: Commands.CMDS.project_run, command: runProject });
                // registry({ name: CMDS.project_debug, label: "Debug Project", command: null, icon: "debug.png" });
                registry({ name: Commands.CMDS.project_classDiagram, command: showDiagram });
                registry({ name: Commands.CMDS.project_configure, command: configureProject });
                registry({ name: Commands.CMDS.project_document, command: documentProject });
            };
        ...
        var SourceEditorContextMenu = (function (_super) {
            ...
            SourceEditorContextMenu.prototype.getInfoAt = function (type) {
                this.getIsense().getCrossReference(type, this.editor.filePath, this.getPos(), function (err, data) {
                    ...
                    var page = IDE.problemPane.addPage("info_tab", null, resultTable);
    ...
    (function (Gui) {
        ...
        var ResultTable = (function (_super) {
            ...
            function ResultTable(headers) {
                ...
                var columns = [];
                headers.forEach(function (header) { return columns.push(_this.tr("result_table_" + header)); });
    ...
    (function (Gui) {
        ...
        var TabViewPage = (function (_super) {
            ...
            function TabViewPage(id, tooltipText, widget) {
                var _this = this;
                _super.call(this, _super.prototype.tr.call(this, id), getIconName(id));
                this.id = id;
