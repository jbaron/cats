...
(function (Cats) {
    ...
    Cats.EventEmitter = EventEmitter;    
})(Cats || (Cats = {}));
var Cats;
(function (Cats) {
    var Ide = (function () {
        ...
        Ide.prototype.removeSession = function (session) {
            var result = [];
...
(function (Cats) {
    ...
    (function (Event) {
        ...
        Event._map[6] = "overwriteModeChanged";
        Event.overwriteModeChanged = 6;
    ...
    ;
    var EventBusImpl = (function () {
        function EventBusImpl() {
            this.suscribers = [];
        }
        EventBusImpl.prototype.emit = function (event, data, old) {
        ...
        EventBusImpl.prototype.on = function (event, subscriber) {
    ...
    Cats.EventBusImpl = EventBusImpl;    
    ;
    Cats.EventBus = new EventBusImpl();
})(Cats || (Cats = {}));
var Cats;
(function (Cats) {
    (function (Commands) {
...
(function (Cats) {
    ...
    var SessionList = (function (_super) {
        ...
        SessionList.prototype.get = function (name) {
            for(var i = 0; i < this.sessions.length; i++) {
                var session = this.sessions[i];
                if(session.name === name) {
                    return session;
        ...
        SessionList.prototype.remove = function (session) {
    ...
    var Session = (function () {
        function Session(project, name, content) {
            ...
            this.editSession.on("changeOverwrite", function () {
                Cats.EventBus.emit(Cats.Event.overwriteModeChanged, _this.editSession.getOverwrite());
            });
...
(function (Cats) {
    ...
    function initStatusBar() {
        ...
        Cats.EventBus.on(Cats.Event.overwriteModeChanged, function (mode) {
            var session = Cats.mainEditor.activeSession;
            if(session) {
