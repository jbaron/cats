        ...
        */
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                ...
                registry({ name: 44 /* ide_theme */, label: "Theme", command: setTheme });
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                ...
                registry({ name: 41 /* project_dependencies */, label: "Show Dependencies", command: showDependency });
            };
        ...
        */
        var Menubar = (function () {
            function Menubar() {
                ...
                proj.append(getCmd(41 /* project_dependencies */));
...
var ToolBar = (function (_super) {
    ...
    ToolBar.prototype.addThemes = function () {
        var _this = this;
        this.themes.forEach(function (theme) {
    ...
    */
    ...
    AutoCompletePopup.prototype.getIconForKind = function (name) {
        switch (name) {
            ...
            case "keyword":
            case "method":
                return "./img/16/method.png";
            case "constructor":
                return "./img/16/constructor.png";
            case "module":
                return "./img/16/module.png";
            case "interface":
                return "./img/16/interface.png";
            case "enum":
                return "./img/16/enum.png";
            case "class":
                return "./img/16/class.png";
            case "var":
                return "./img/16/variable.png";
            default:
                return "./img/16/method.png";
        }
    };
