        ...
        */
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                ...
                registry({ name: 45 /* ide_theme */, label: "Theme", command: setIdeTheme });
                registry({ name: 46 /* ide_fontSize */, label: "Font Size", command: setFontSize });
                registry({ name: 47 /* ide_rightMargin */, label: "Right Margin", command: setRightMargin });
    ...
    (function (Commands) {
        ...
        var RefactorCommands = (function () {
            ...
            RefactorCommands.init = function (registry) {
                registry({ name: 43 /* refactor_rename */, label: "Rename", command: rename });
            };
        ...
        */
        var Menubar = (function () {
            function Menubar() {
                ...
                refactor.append(getCmd(43 /* refactor_rename */));
            ...
            Menubar.prototype.createFontSizeMenu = function () {
                ...
                this.fontSizes.forEach(function (size) {
                    var item = getCmd(46 /* ide_fontSize */, size + "px", size);
                    menu.append(item);
                });
                return menu;
            };
            ...
            Menubar.prototype.createMarginMenu = function () {
                ...
                [80, 100, 120, 140, 160, 180, 200].forEach(function (margin) {
                    var item = getCmd(47 /* ide_rightMargin */, margin.toString(), margin);
                    menu.append(item);
                });
                return menu;
            };
            ...
            Menubar.prototype.createThemeMenu = function () {
                ...
                this.themes.forEach(function (theme) {
                    if (theme.theme) {
                        var item = getCmd(45 /* ide_theme */, theme.label, theme.theme);
                        menu.append(item);
                    } else {
...
var SourceEditor = (function (_super) {
    ...
    */
    ...
    SourceEditor.prototype.createContextMenu = function () {
        ...
        menu.add(this.createContextMenuItem("Undo", function () {
            _this.aceEditor.execCommand("undo");
        }));
