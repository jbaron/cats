    ...
    (function (Commands) {
        ...
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                ...
                registry(Commands.CMDS.ide_toggle_toolbar, function () { return toggleView(IDE.toolBar); });
                registry(Commands.CMDS.ide_toggle_statusbar, function () { return toggleView(IDE.statusBar); });
                registry(Commands.CMDS.ide_toggle_result, function () { return toggleView(IDE.problemPane); });
                registry(Commands.CMDS.ide_toggle_outline, function () { return toggleView(IDE.infoPane); });
