        ...
        FileEditor.OpenEditor = function (fileName, pos) {
            ...
            if (!pages.length) {
                ...
                if (!editor) {
                    ...
                    if (!c)
                        return;
                    editor = new Cats.Gui.Editor.SourceEditor(fileName);
                }
            ...
            var EditSession = (function (_super) {
                ...
                EditSession.prototype.save = function () {
                    ...
                    if (filePath == null) {
                        ...
                        if (this.isTypeScript() && (!Cats.IDE.project.hasScriptFile(filePath))) {
                            var isProjectFile = confirm("Not yet part of project, add it now?");
                            if (isProjectFile)
...
(function (Cats) {
    ...
    (function (Gui) {
        function handleClick() {
            ...
            if (!Cats.OS.File.PATH.isAbsolute(fileName)) {
                fileName = Cats.OS.File.join(Cats.IDE.project.projectDir, fileName);
            }
