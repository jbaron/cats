...
(function (Cats) {
    ...
    var Ide = (function () {
        ...
        */
        ...
        Ide.prototype.createEditor = function (fileName) {
        ...
        * a new one.
        */
        Ide.prototype.openEditor = function (name, pos) {
        ...
        */
        Session.prototype.updateOutline = function (timeout) {
            ...
            this.outlineTimer = setTimeout(function () {
                _this.editor.project.iSense.getScriptLexicalStructure(_this.editor.filePath, function (err, data) {
    ...
    (function (Refactor) {
        ...
        function renameOccurences(edits, name) {
            for (var i = edits.length - 1; i >= 0; i--) {
                var data = edits[i];
                var editor = IDE.openEditor(data.fileName);
                var r = data.range;
...
(function (Cats) {
    ...
    */
    var Editor = (function (_super) {
        ...
        Editor.prototype.restoreState = function (state) {
        };
    ...
    var FileEditor = (function (_super) {
        ...
        FileEditor.prototype.updateProperties = function () {
            if (this.filePath) {
                try  {
                    this.properties = Cats.OS.File.getProperties(this.filePath);
    ...
    */
    var Linter = (function () {
        ...
        */
        ...
        Linter.prototype.lint = function (name, content) {
            var _this = this;
...
(function (Cats) {
    (function (Gui) {
        ...
        var TSCompleter = (function () {
            function TSCompleter(editor, aceEditor) {
                var _this = this;
                this.editor = editor;
            ...
            TSCompleter.prototype.liveAutoComplete = function (e) {
                var text = e.args || "";
        ...
        var FileNavigator = (function (_super) {
            ...
            FileNavigator.prototype.setProject = function (project) {
                ...
                this.addListener("dblclick", function () {
                    ...
                    if (file) {
                        IDE.openEditor(file.getFullPath());
                    }
                });
        ...
        */
        var OutlineNavigator = (function (_super) {
            ...
            function OutlineNavigator() {
                ...
                IDE.editorTabView.addListener("changeSelection", function (ev) {
                    var page = ev.getData()[0];
                    if (page) {
                        _this.page = page;
                        _this.register(page.editor);
                    } else {
                        _this.register(null);
                    }
                });
            ...
            OutlineNavigator.prototype.register = function (editor) {
                if (this.editor) {
        ...
        */
        var SourceEditor = (function (_super) {
            ...
            function SourceEditor(fileName) {
                ...
                var content = fileName ? Cats.OS.File.readTextFile(fileName) : "";

                this.mode = modelist.getModeForPath(fileName).mode;

                this.editSession = new ace.EditSession(content, this.mode);
                ...
                this.editSession.on("changeAnnotation", function () {
                    var a = _this.editSession.getAnnotations();
                    _this.emit("errors", a);
                });
            ...
            */
            ...
            SourceEditor.prototype.setupEvents = function () {
                ...
                this.editSession.on("changeOverwrite", function (a) {
                    IDE.infoBus.emit("editor.overwrite", _this.editSession.getOverwrite());
                });
            };
            ...
            */
            ...
            SourceEditor.prototype.createAceEditor = function (rootElement) {
                ...
                if (this.isTypeScript()) {
                    editor.completers = [new Gui.TSCompleter(this, editor), Gui.snippetCompleter];
            ...
            SourceEditor.prototype.gotoDeclaration = function () {
                this.project.iSense.getDefinitionAtPosition(this.filePath, this.getPosition(), function (err, data) {
            ...
            SourceEditor.prototype.getInfoAt = function (type) {
                this.project.iSense.getInfoAtPosition(type, this.filePath, this.getPosition(), function (err, data) {
                    if (!data)
                        return;
            ...
            SourceEditor.prototype.refactor = function () {
                ...
                Cats.Refactor.rename(this.filePath, this.project, pos);
            };
            ...
            SourceEditor.prototype.createContextMenuItem = function (name, fn, self) {
    ...
    (function (Gui) {
        ...
        */
        var EditorPage = (function (_super) {
            ...
            */
            EditorPage.prototype.setHasErrors = function (errors) {
                if (errors.length > 0) {
        ...
        var EditorTabView = (function (_super) {
            ...
            */
            EditorTabView.prototype.getActiveSession = function () {
            ...
            * Get the currently active session
            */
            EditorTabView.prototype.getActiveEditor = function () {
                var page = this.getActivePage();
                if (!page)
                    return null;
                return page.editor;
            ...
            EditorTabView.prototype.navigateToPage = function (page, pos, storeHistory) {
    ...
    (function (Gui) {
        ...
        */
        var AutoCompletePopup = (function (_super) {
            ...
            */
            AutoCompletePopup.prototype.complete = function () {
                var _this = this;
        ...
        */
        var TSHelper = (function () {
            ...
            TSHelper.prototype.init = function () {
                var _this = this;
                this.getWidget().addListener("appear", function () {
            ...
            TSHelper.prototype.setOutline = function (outline) {
                this.outline = outline;
                this.editor.emit("outline", this.outline);
            };
            ...
            TSHelper.prototype.updateContent = function (content) {
                this.editor.project.iSense.updateScript(this.editor.filePath, this.editor.getContent());
                this.updateDiagnostics();
            };
