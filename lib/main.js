    ...
    var Project = (function (_super) {
        ...
        Project.prototype.refresh = function () {
            ...
            if (!this.config.compiler.noLib) {
                var fullName = Cats.OS.File.join(IDE.catsHomeDir, "resource/typings/lib.d.ts");
    ...
    (function (Refactor) {
        ...
        function rename(fileName, project, pos) {
            project.iSense.getRenameInfo(fileName, pos, function (err, data) {
                ...
                if (!newName)
                    return;
                project.iSense.getCrossReference("getReferencesAtPosition", fileName, pos, function (err, data) {
...
(function (Cats) {
    ...
    var Editor = (function (_super) {
        ...
        function Editor() {
            ...
            this.label = "Untitled"; // Labe to be used on the tab page
        ...
        FileEditor.OpenEditor = function (fileName, pos) {
            ...
            if (!pages.length) {
                ...
                if (!editor) {
                    ...
                    if (!c)
                        return;
                    editor = new Cats.Gui.SourceEditor(fileName);
                }
    ...
    (function (Commands) {
        ...
        var EditorCommands = (function () {
            ...
            EditorCommands.init = function (registry) {
                ...
                registry({ name: Commands.CMDS.edit_toggleInvisibles, label: "Toggle Invisible Characters", command: toggleInvisibles });
                registry({ name: Commands.CMDS.source_format, label: "Format Code", command: formatText });
                registry({ name: Commands.CMDS.edit_cut, label: "Cut", command: function () {
                    document.execCommand("cut");
                } });
                registry({ name: Commands.CMDS.edit_copy, label: "Copy", command: function () {
                    document.execCommand("copy");
                } });
                registry({ name: Commands.CMDS.edit_paste, label: "Paste", command: function () {
    ...
    (function (Commands) {
        ...
        var FileCommands = (function () {
            ...
            FileCommands.init = function (registry) {
                ...
                registry({ name: Commands.CMDS.file_save, label: "Save File", command: saveFile });
                registry({ name: Commands.CMDS.file_saveAll, label: "Save All", command: saveAll });
                registry({ name: Commands.CMDS.file_saveAs, label: "Save As....", command: saveAs });
            };
            return FileCommands;
        })();
    ...
    (function (Commands) {
        ...
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                registry({ name: Commands.CMDS.ide_quit, label: "Quit CATS", command: quit });
                registry({ name: Commands.CMDS.ide_toggleView, label: "Toggle View", command: toggleView });
                registry({ name: Commands.CMDS.ide_configure, label: "Preferences....", command: configureIde });
                registry({ name: Commands.CMDS.ide_history_next, label: "Next", command: next });
                registry({ name: Commands.CMDS.ide_history_prev, label: "Previous", command: prev });
            };
            return IdeCommands;
        })();
    ...
    (function (Commands) {
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                ...
                registry({ name: Commands.CMDS.project_classDiagram, label: "Class Diagram", command: showDiagram });
                registry({ name: Commands.CMDS.project_configure, label: "Settings....", command: configureProject });
                registry({ name: Commands.CMDS.project_document, label: "Generate Documentation", command: documentProject });
            };
        ...
        var AutoCompletePopup = (function (_super) {
            ...
            AutoCompletePopup.prototype.updateFilter = function () {
                ...
                delegate["filter"] = function (data) {
                    ...
                    var result = _this.match_forgiven(text, value); // TODO hwo to deal with this
                    if (result)
            ...
            AutoCompletePopup.isJsIdentifierPart = function (ch) {
                ...
                return ch >= 97 && ch <= 122 || ch >= 65 && ch <= 90 || ch >= 48 && ch <= 57 || ch === 95 || ch === 36 || ch > 127; //non-ASCII letter. Not accurate, but good enough for autocomplete
            };
        ...
        var ProjectCompilerSettings = (function (_super) {
            ...
            function ProjectCompilerSettings() {
                ...
                this.moduleGenTarget = [
                    { label: "none", model: 0 /* Unspecified */ },
                    { label: "commonjs", model: 1 /* Synchronous */ },
                    { label: "amd", model: 2 /* Asynchronous */ },
                ];
                this.jsTarget = [
    ...
    (function (Gui) {
        ...
        var PropertyTable = (function (_super) {
            ...
            function PropertyTable(headers) {
                if (headers === void 0) { headers = ["Name", "Value"]; }
                var tableModel = new qx.ui.table.model.Simple();
                tableModel.setColumns(headers);
                tableModel.setData([]);
                this.setStatusBarVisible(false);
        ...
        var Menubar = (function () {
            ...
            Menubar.prototype.createViewMenu = function () {
                ...
                views.forEach(function (view) {
                    var item = _this.getMenuCommand(CMDS.ide_toggleView, view.name, view.id);
                    menu.append(item);
                });
            };
            return Menubar;
