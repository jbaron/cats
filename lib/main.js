...
(function (Cats) {
    var Ide = (function () {
        ...
        Ide.prototype.layout = function () {
            ...
            if (this.toolBar.getBackgroundColor())
                mainsplit.setBackgroundColor(this.toolBar.getBackgroundColor());
...
var ConsoleLog = (function (_super) {
    ...
    ConsoleLog.prototype.log = function (msg, printTime, severity) {
...
var SourceEditor = (function (_super) {
    ...
    function SourceEditor(session, pos) {
        ...
        this.addListenerOnce("appear", function () {
            ...
            var aceSession = _this.aceEditor.getSession();
            aceSession.setMode("ace/mode/" + session.mode);
            aceSession.setValue(session.content);

            aceSession.on("change", _this.onChangeHandler.bind(_this));
    ...
    */
    ...
    SourceEditor.prototype.setFontSize = function (size) {
    ...
    */
    SourceEditor.prototype.showErrors = function () {
        var _this = this;
        if (this.session.mode === "typescript") {
            // TODO get its own timer
            IDE.project.iSense.getErrors(this.session.name, function (err, result) {
                var annotations = [];
                if (result) {
                ...
                _this.aceEditor.getSession().setAnnotations(annotations);
                _this.fireDataEvent("editor.errors", annotations.length);
            });
        }
    };
...
var SessionPage = (function (_super) {
    ...
    function SessionPage(session, pos) {
        ...
        this.editor.addListener("editor.update", function () {
            _this.setChanged(true);
        });
        this.editor.addListener("editor.errors", function (ev) {
            _this.setHasErrors(ev.getData());
        });
    }
...
var SessionTabView = (function (_super) {
    ...
    */
    SessionTabView.prototype.setRightMargin = function (margin) {
        // IDE.config.rightMargin = margin;
        // IDE.mainEditor.aceEditor.setPrintMarginColumn(margin);
    };

    SessionTabView.prototype.setFontSize = function (size) {
        this.getChildren().forEach(function (child) {
...
var AutoCompletePopup = (function (_super) {
    ...
    function AutoCompletePopup(editor) {
        ...
        this.addListenerOnce("appear", function () {
            var container = _this.getContentElement().getDomElement();
            _this.initKeys();
            container.appendChild(_this.listElement);
    ...
    */
    AutoCompletePopup.prototype.strictComparison = function (a, b) {
    ...
    */
    AutoCompletePopup.prototype.looseComparison = function (a, b) {
    ...
    * so far.
    */
    AutoCompletePopup.prototype.filter = function () {
        var _this = this;
    ...
    */
    AutoCompletePopup.prototype.filter2 = function () {
        var text = this.getInputText();
        if (!text) {
            this.filteredCompletions = this.completions;
        } else {
    ...
    */
    AutoCompletePopup.prototype.initKeys = function () {
        var _this = this;
    ...
    *
    */
    AutoCompletePopup.prototype.showPopup = function (coords) {
        var _this = this;
    ...
    * Render a single row
    */
    AutoCompletePopup.prototype.renderRow = function () {
    ...
    *
    */
    AutoCompletePopup.prototype.hasCompletions = function () {
        return this.filteredCompletions.length > 0;
    };

    AutoCompletePopup.prototype.render = function () {
    ...
    AutoCompletePopup.prototype.highLite = function () {
        var elem = this.listElement.children[this.cursorPos];
        elem.className = AutoCompletePopup.selectedClassName;
    };

    AutoCompletePopup.prototype.moveCursor = function (offset) {
        if (!this.hasCompletions())
            return;
    ...
    AutoCompletePopup.prototype.current = function () {
        if (this.cursorPos >= 0)
            return this.listElement.childNodes[this.cursorPos];
        else
            return null;
    };

    AutoCompletePopup.prototype.hideRow = function (index) {
        var elem = this.listElement.children[index];
        elem.style.display = "none";
    };

    AutoCompletePopup.prototype.showRow = function (index) {
        var elem = this.listElement.children[index];
    ...
    * or the reverse.
    */
    AutoCompletePopup.prototype.scroll = function () {
    ...
    AutoCompletePopup.selectedClassName = 'autocomplete_selected';
    AutoCompletePopup.className = 'autocomplete';
