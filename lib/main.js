        ...
        var EditorCommands = (function () {
            ...
            EditorCommands.init = function (registry) {
                var editorCommands = [
                    ...
                    { id: 13 /* edit_redo */, label: "Redo", icon: "redo.gif" },
                    { id: 25 /* edit_indent */, label: "Indent" },
                    { id: 26 /* edit_outdent */, label: "Outdent" },
                    ...
                    { id: 24 /* edit_toggleComment */, label: "Toggle Comment", cmd: "togglecomment", icon: "comment.png" },
                ...
                registry({ name: 27 /* source_format */, label: "Format Code", command: formatText, icon: "static/img/format.png" });
            };
        ...
        */
        ...
        var FileCommands = (function () {
            ...
            FileCommands.init = function (registry) {
                registry({ name: 4 /* file_new */, label: "New File", command: newFile, icon: "static/img/new.png" });
                ...
                registry({ name: 11 /* file_saveAll */, label: "Save All", command: saveAll, icon: "static/img/save.png" });
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                registry({ name: 31 /* project_open */, label: "Open Project...", command: openProject, icon: "static/img/open.png" });
                registry({ name: 32 /* project_close */, label: "Close project", command: closeProject });
                registry({ name: 33 /* project_build */, label: "Build Project", command: buildProject, icon: "static/img/build.png" });
                registry({ name: 34 /* project_validate */, label: "Validate Project", command: validateProject });
                registry({ name: 37 /* project_refresh */, label: "Refresh Project", command: refreshProject, icon: "static/img/refresh.png" });
                registry({ name: 35 /* project_run */, label: "Run Project", command: runProject, icon: "static/img/run.png" });

                // registry({ name: CMDS.project_debug, label: "Debug Project", command: null, icon: "static/img/debug.png" });
