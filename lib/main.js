        ...
        */
        ...
        Ide.prototype.initTabBar = function () {
            ...
            tb.onselect = function (session) {
                return _this.openSession(session.name);
            };
        ...
        */
        AceSession.prototype.persist = function () {
            ...
            if (IDE.project.config.buildOnSave && (this.mode === "typescript"))
                Cats.Commands.runCommand(33 /* project_build */);
        };
    ...
    (function (Commands) {
        ...
        */
        (function (CMDS) {
            ...
            CMDS[CMDS["edit_toggleRecording"] = 22] = "edit_toggleRecording";
            CMDS[CMDS["edit_replayMacro"] = 23] = "edit_replayMacro";

            CMDS[CMDS["edit_toggleComment"] = 24] = "edit_toggleComment";
            CMDS[CMDS["edit_indent"] = 25] = "edit_indent";
            CMDS[CMDS["edit_outdent"] = 26] = "edit_outdent";

            CMDS[CMDS["source_format"] = 27] = "source_format";
            CMDS[CMDS["source_openDeclaration"] = 28] = "source_openDeclaration";
            CMDS[CMDS["source_findRef"] = 29] = "source_findRef";
            CMDS[CMDS["source_findDecl"] = 30] = "source_findDecl";

            CMDS[CMDS["project_open"] = 31] = "project_open";
            CMDS[CMDS["project_close"] = 32] = "project_close";
            CMDS[CMDS["project_build"] = 33] = "project_build";
            CMDS[CMDS["project_validate"] = 34] = "project_validate";
            CMDS[CMDS["project_run"] = 35] = "project_run";
            CMDS[CMDS["project_debug"] = 36] = "project_debug";
            CMDS[CMDS["project_refresh"] = 37] = "project_refresh";
            CMDS[CMDS["project_properties"] = 38] = "project_properties";
            CMDS[CMDS["project_dependencies"] = 39] = "project_dependencies";

            CMDS[CMDS["navigate_references"] = 40] = "navigate_references";
            CMDS[CMDS["navigate_occurences"] = 41] = "navigate_occurences";
            CMDS[CMDS["navigate_implementors"] = 42] = "navigate_implementors";
            CMDS[CMDS["navigate_declaration"] = 43] = "navigate_declaration";
        ...
        */
        function init() {
            Cats.Commands.EditorCommands.init(register);
            Cats.Commands.FileCommands.init(register);
            Cats.Commands.HelpCommands.init(register);
            Cats.Commands.ProjectCommands.init(register);
            Cats.Commands.IdeCommands.init(register);
            Cats.Commands.RefactorCommands.init(register);
            Cats.Commands.NavigateCommands.init(register);
        }
        Commands.init = init;
    ...
    (function (Commands) {
        ...
        var EditorCommands = (function () {
            ...
            EditorCommands.init = function (registry) {
                var editorCommands = [
                    { id: 12 /* edit_undo */, label: "Undo", icon: "undo_edit.gif" },
                    { id: 13 /* edit_redo */, label: "Redo", icon: "redo_edit.gif" },
                    { id: 25 /* edit_indent */, label: "indent", icon: "shift_r_edit.gif" },
                    { id: 26 /* edit_outdent */, label: "outdent", icon: "shift_l_edit.gif" },
                    { id: 14 /* edit_cut */, label: "cut", icon: "cut_edit.gif" },
                    { id: 15 /* edit_copy */, label: "copy", icon: "copy_edit.gif" },
                    { id: 16 /* edit_paste */, label: "paste", icon: "paste_edit.gif" },
                    ...
                    { id: 20 /* edit_replace */, label: "Replace", cmd: "replace" },
                    { id: 21 /* edit_replaceAll */, label: "Replace All", cmd: "replaceall" },
                    { id: 24 /* edit_toggleComment */, label: "Toggle Comment", cmd: "togglecomment" },
                    { id: 22 /* edit_toggleRecording */, label: "Start/stop Recording", cmd: "togglerecording" },
                    { id: 23 /* edit_replayMacro */, label: "Playback Macro", cmd: "replaymacro" }
                ];
                ...
                registry({ name: 27 /* source_format */, label: "Format Code", command: formatText });
            };
        ...
        */
        ...
        var FileCommands = (function () {
            ...
            FileCommands.init = function (registry) {
                registry({ name: 4 /* file_new */, label: "New File", command: newFile });
                ...
                registry({ name: 9 /* file_save */, label: "Save File", icon: "static/img/save_edit.gif", command: saveFile });
                registry({ name: 11 /* file_saveAll */, label: "Save All", icon: "static/img/saveall_edit.gif", command: saveAll });
                registry({ name: 10 /* file_saveAs */, label: "Save As...", icon: "static/img/saveas_edit.gif", command: saveAs });
            };
            return FileCommands;
        })();
        ...
        */
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                ...
                registry({ name: 46 /* ide_theme */, label: "Theme", command: setTheme });
    ...
    (function (Commands) {
        ...
        var NavigateCommands = (function () {
            ...
            NavigateCommands.init = function (registry) {
                registry({ name: 40 /* navigate_references */, label: "Find References", command: findReferences });
                registry({ name: 42 /* navigate_implementors */, label: "Find Implementations", command: findImplementors });
                registry({ name: 41 /* navigate_occurences */, label: "Find Occurences", command: findOccurences });
                registry({ name: 43 /* navigate_declaration */, label: "Goto Declaration", command: gotoDeclaration });
            };
        ...
        */
        ...
        var ProjectCommands = (function () {
            ...
            ProjectCommands.init = function (registry) {
                registry({ name: 31 /* project_open */, label: "Open Project...", command: openProject });
                registry({ name: 32 /* project_close */, label: "Close project", command: closeProject });
                registry({ name: 33 /* project_build */, label: "Build Project", command: buildProject });
                registry({ name: 34 /* project_validate */, label: "Validate Project", command: validateProject });
                registry({ name: 37 /* project_refresh */, label: "Refresh Project", command: refreshProject });
                registry({ name: 35 /* project_run */, label: "Run Project", command: runProject });
                registry({ name: 36 /* project_debug */, label: "Debug Project", command: null });
                registry({ name: 38 /* project_properties */, label: "Properties", command: propertiesProject });
                registry({ name: 39 /* project_dependencies */, label: "Show Dependencies", command: showDependency });
            };
        ...
        TextEditor.prototype.createAceEditor = function () {
            ...
            editor.commands.addCommands([
                ...
                },
                {
                    ...
                    exec: function () {
                        Cats.Commands.runCommand(43 /* navigate_declaration */);
                    }
                },
                {
                    name: "save",
        ...
        */
        var EditorContextMenu = (function () {
            ...
            EditorContextMenu.prototype.init = function () {
                ...
                // Add the items
                this.ctxmenu.append(getCmd(43 /* navigate_declaration */));
                this.ctxmenu.append(getCmd(40 /* navigate_references */));
                this.ctxmenu.append(getCmd(41 /* navigate_occurences */));
                this.ctxmenu.append(getCmd(42 /* navigate_implementors */));
            };
    ...
    (function (Menu) {
        ...
        */
        var Menubar = (function () {
            function Menubar() {
                this.fontSizes = [8, 10, 12, 14, 16, 18, 20, 24];
                this.themes = [
                ...
                edit.append(new GUI.MenuItem({ type: "separator" }));
                edit.append(getCmd(22 /* edit_toggleRecording */));
                edit.append(getCmd(23 /* edit_replayMacro */));

                var source = new GUI.Menu();
                source.append(getCmd(24 /* edit_toggleComment */));
                source.append(getCmd(25 /* edit_indent */));
                source.append(getCmd(26 /* edit_outdent */));
                source.append(getCmd(27 /* source_format */));

                var refactor = new GUI.Menu();
                refactor.append(getCmd(44 /* refactor_rename */));

                var navigate = new GUI.Menu();
                navigate.append(getCmd(43 /* navigate_declaration */));
                navigate.append(getCmd(40 /* navigate_references */));
                navigate.append(getCmd(41 /* navigate_occurences */));
                navigate.append(getCmd(42 /* navigate_implementors */));

                var proj = new GUI.Menu();
                proj.append(getCmd(31 /* project_open */));
                proj.append(getCmd(32 /* project_close */));
                proj.append(new GUI.MenuItem({ type: "separator" }));
                proj.append(getCmd(33 /* project_build */));
                proj.append(getCmd(34 /* project_validate */));
                ...
                proj.append(getCmd(37 /* project_refresh */));
                proj.append(getCmd(38 /* project_properties */));
                proj.append(getCmd(39 /* project_dependencies */));

                var run = new GUI.Menu();
                run.append(getCmd(35 /* project_run */));
                run.append(getCmd(36 /* project_debug */));
            ...
            Menubar.prototype.createViewMenu = function () {
                ...
                views.forEach(function (view) {
                    var item = getCmd(48 /* ide_toggleView */, view.name, view.id);
                    menu.append(item);
                });
                return menu;
            };
        ...
        var StatusBar = (function (_super) {
            ...
            */
            ...
            StatusBar.prototype.initStatusBar = function () {
                ...
                infoBus.SESSION.on("editMode", function (mode) {
...
infoBus.SESSION.on("overwrite", function (a) {
    console.dir(a);
});
