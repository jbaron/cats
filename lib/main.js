...
(function (Cats) {
    (function (Menu) {
        ...
        function showErrors2(errors) {
            ...
            grid.render();
            var result = Menu.IDE.compilationResult;
            result.innerHTML = "";
        ...
        var Menubar = (function () {
            function Menubar() {
                ...
                refactor.append(new Menu.gui.MenuItem({
                    label: 'Rename',
                    click: refactorRename
                }));
                var navigate = new Menu.gui.Menu();
                navigate.append(new Menu.gui.MenuItem({
                ...
                run.append(new Menu.gui.MenuItem({
                    label: 'Run main',
                    click: this.runFile
                }));
                run.append(new Menu.gui.MenuItem({
                ...
                help.append(new Menu.gui.MenuItem({
            ...
            Menubar.prototype.refreshProject = function () {
            ...
            Menubar.prototype.runFile = function () {
                ...
                var win2 = Menu.gui.Window.open(startPage, {
                    toolbar: true,
                    webkit: {
                        "page-cache": false
                    }
    ...
    (function (Menu) {
        ...
        function rename() {
            ...
            if(c) {
                ...
                try  {
                    Cats.fs.renameSync(Cats.path.join(root, data.key), Cats.path.join(root, name));
                } catch (err) {
                    alert(err);
                }
            }
    ...
    (function (Menu) {
        ...
        var EditorContextMenu = (function () {
            function EditorContextMenu(editor) {
                ...
                this.ctxmenu.append(new Menu.gui.MenuItem({
        ...
        navbar.setOptions([
            {
                ...
                elem: Cats.IDE.fileNavigation
            }, 
            {
                name: "Outline",
                selected: false,
                decorator: "icon-outline",
                elem: Cats.IDE.outlineNavigation
            }
        ]);
        navbar.appendTo(Cats.IDE.navigationBar);
        navbar.onselect = function (item) {
