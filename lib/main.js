    ...
    (function (OS) {
        ...
        (function (File) {
            ...
            function determineNewLIneMode() {
                try {
                    var mode = Cats.IDE.project.config.codingStandards.newLineMode;
            ...
            function writeTextFile(name, value, stat) {
                ...
                var fileName = name;
                if (!File.PATH.isAbsolute(fileName)) {
                    fileName = File.PATH.join(Cats.IDE.project.projectDir, fileName);
                }
            ...
            this.worker.onmessage = function (e) {
                ...
                if (id) {
                    ...
                    if (msg.method && (msg.method === "setBusy")) {
                        Cats.IDE.statusBar.setBusy(msg.params[0]);
                    }
    ...
    (function (Commands) {
        ...
        function formatText() {
            ...
            if (editor && editor.isTypeScript && editor.isTypeScript()) {
                ...
                Cats.IDE.project.iSense.getFormattedTextForRange(editor.filePath, range, function (err, result) {
                    if (!err) {
        ...
        var EditorCommands = (function () {
            ...
            EditorCommands.init = function (registry) {
                ...
                registry(Commands.CMDS.edit_cut, function () {
                    document.execCommand("cut");
                });
                registry(Commands.CMDS.edit_copy, function () {
                    document.execCommand("copy");
                });
                registry(Commands.CMDS.edit_paste, function () {
...
(function (Cats) {
    ...
    (function (Commands) {
         ...
         */
        function newFile() {
            Cats.IDE.editorTabView.addEditor(new Cats.Gui.SourceEditor(), { row: 0, column: 0 });
        }
        /**
         ...
         */
        function saveAs() {
            var editor = Cats.IDE.editorTabView.getActiveEditor(Cats.Gui.SourceEditor);
            if (editor) {
...
(function (Cats) {
    ...
    (function (Commands) {
        ...
        function configureIde() {
            var w = new Cats.Gui.IdeConfigDialog(Cats.IDE.config);
        ...
        var IdeCommands = (function () {
            ...
            IdeCommands.init = function (registry) {
                ...
                registry(Commands.CMDS.ide_toggle_result, function () { return toggleView(Cats.IDE.problemPane); });
                registry(Commands.CMDS.ide_toggle_outline, function () { return toggleView(Cats.IDE.infoPane); });
...
(function (Cats) {
    ...
    (function (Commands) {
        ...
        function closeAllProjects() {
            Cats.IDE.closeProject(Cats.IDE.project);
        }
        /**
         * Close the project
         */
        ...
        function showDiagram() {
            Cats.IDE.editorTabView.addEditor(new Cats.Gui.UMLEditor("Class Diagram"));
        }
        /**
        ...
        function configureProject() {
            var w = new Cats.Gui.ProjectConfigDialog(Cats.IDE.project);
            w.show();
        }
        /**
        ...
        function openProject() {
            ...
            chooser.onchange = function (evt) {
                ...
                if (!Cats.IDE.project) {
                    Cats.IDE.addProject(new Cats.Project(projectPath));
                }
                else {
        ...
        var SourceEditor = (function (_super) {
            ...
            SourceEditor.prototype.informWorld = function () {
                ...
                this.status = {
                    ...
                    mode: Cats.OS.File.PATH.basename(this.mode).toUpperCase(),
                    position: label
                };
            ...
            SourceEditor.prototype.save = function () {
                if (this.filePath == null) {
                    var dir = Cats.OS.File.join(this.project.projectDir, "/");
                ...
                this.updateFileInfo();
                Cats.IDE.console.log("Saved file " + this.filePath);
                if (this.isTypeScript()) {
                    this.project.iSense.updateScript(this.filePath, this.getContent());
        ...
        var SourceEditorContextMenu = (function (_super) {
            ...
            SourceEditorContextMenu.prototype.getInfoAt = function (type) {
                this.getIsense().getCrossReference(type, this.editor.filePath, this.getPos(), function (err, data) {
                    ...
                    var page = Cats.IDE.problemPane.addPage("info_tab", null, resultTable);
    ...
    (function (Gui) {
        ...
        var EditSession = (function (_super) {
            ...
            function EditSession(content, mode, editor) {
                ...
                Cats.IDE.project.on("config", function () {
...
(function (Cats) {
    ...
    (function (Gui) {
        function getIconName(name) {
            var entry = Cats.IDE.icons.tab[name];
            if (entry)
                return entry;
    ...
    (function (Gui) {
        ...
        var EditorPage = (function (_super) {
            ...
            EditorPage.prototype.createContextMenu = function () {
                ...
                item1.addListener("execute", function () {
                    Cats.IDE.editorTabView.close(_this);
                });
                var item2 = new qx.ui.menu.Button("Close other");
                item2.addListener("execute", function () {
                    Cats.IDE.editorTabView.closeOther(_this);
                });
...
(function (Cats) {
    ...
    (function (Gui) {
        ...
        var ConfigDialogPage = (function (_super) {
            ...
            ConfigDialogPage.prototype.addCheckBox2 = function (model) {
                var cb = new qx.ui.form.CheckBox();
        ...
        var SearchDialog = (function (_super) {
            ...
            SearchDialog.prototype.run = function (param) {
                ...
                Cats.OS.File.find(param.glob, this.rootDir, function (err, files) {
                    ...
                    var page = Cats.IDE.problemPane.addPage("search", toolTipText, resultTable);
                    page.setShowCloseButton(true);
...
(function (Cats) {
    ...
    function main(app) {
        ...
        if (prjName) {
            Cats.IDE.addProject(new Cats.Project(prjName));
        }
        else {
