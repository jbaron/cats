...
(function (Cats) {
    ...
    var Ide = (function (_super) {
        ...
        Ide.prototype.initFileDropArea = function () {
            ...
            document.documentElement.addEventListener("drop", function (ev) { return _this.acceptFileDrop(ev); }, false);
        ...
        Ide.prototype.close = function () {
            this.projects.forEach(function (project) { return project.close(); });
        ...
        Ide.prototype.savePreferences = function () {
            try {
                var config_1 = this.config;
                config_1.version = "1.1";
                config_1.sessions = [];
                config_1.projects = this.recentProjects;
                this.editorTabView.getEditors().forEach(function (editor) {
                    var state = editor.getState();
                    if ((state !== null) && (editor.getType())) {
                        config_1.sessions.push({
                            state: JSON.stringify(state),
                            type: editor.getType()
                        });
                    }
                });
                var configStr = JSON.stringify(config_1);
         ...
         */
        Ide.prototype.getProject = function (fileName) {
         ...
         */
        Ide.prototype.getTSConfigs = function (dir) {
         ...
         */
        Ide.prototype.setProjectDirectory = function (projectDir, refreshFileNavigator) {
            var _this = this;
            if (refreshFileNavigator === void 0) { refreshFileNavigator = true; }
            this.projects = [];
...
(function (Cats) {
    ...
    var TSWorkerProxy = (function () {
        ...
        TSWorkerProxy.prototype.getTypeDefinitionAtPosition = function (sessionName, cursor, cb) {
        ...
        TSWorkerProxy.prototype.insertDocComments = function (fileName, position, cb) {
        ...
        TSWorkerProxy.prototype.setConfigFile = function (path, content) {
...
(function (Cats) {
    ...
    var Project = (function (_super) {
        ...
        function Project(tsConfigFile) {
            ...
            this.refreshInterval = setInterval(function () { _this.refreshTodoList(); }, 60000);
        }
        ...
        Project.prototype.refreshTodoList = function () {
            ...
            this.iSense.getTodoItems(function (err, data) {
                Cats.IDE.todoList.setData(data, _this);
            });
        };
        /**
         * Close the project
        ...
        Project.prototype.validate = function (verbose) {
            ...
            this.iSense.getAllDiagnostics(function (err, data) {
                if (data) {
                    Cats.IDE.problemResult.setData(data, _this);
                    if ((data.length === 0) && verbose) {
                        Cats.IDE.console.log("Project " + _this.name + " has no errors");
                    }
                }
            });
        };
                ...
                this.iSense.compile(function (err, data) {
                    ...
                    files.forEach(function (file) {
                        if (!Cats.OS.File.PATH.isAbsolute(file.name)) {
                            file.name = Cats.OS.File.PATH.join(_this.projectDir, file.name);
        ...
        Project.prototype.updateScript = function (fullName, content) {
        ...
        */
        Project.prototype.loadProjectSourceFiles = function () {
            var _this = this;
...
(function (Cats) {
    ...
    var FileEditor = (function (_super) {
        ...
        FileEditor.OpenEditor = function (fileName, pos) {
            ...
            var pages = Cats.IDE.editorTabView.getPagesForFile(fileName);
            if (!pages.length) {
...
(function (Cats) {
    ...
    (function (Commands) {
         ...
         */
        function runProject() {
            Cats.IDE.projects.forEach(function (project) { return project.run(); });
        }
        ;
        /**
        ...
        function validateProject() {
            Cats.IDE.projects.forEach(function (project) { return project.validate(); });
        }
        /**
         * Build the project
         */
        function buildProject() {
            Cats.IDE.projects.forEach(function (project) { return project.build(); });
        }
        /**
        ...
        function newProject() {
            ...
            chooser.onchange = function (evt) {
                Cats.IDE.setProjectDirectory(this.value);
            };
            chooser.click();
        }
        ;
    ...
    (function (Gui) {
        ...
        (function (Editor) {
            ...
            var SourceEditor = (function (_super) {
                ...
                Object.defineProperty(SourceEditor.prototype, "project", {
                    get: function () {
                 ...
                 *
                 */
                SourceEditor.prototype.hasProject = function () {
    ...
    (function (Gui) {
        ...
        (function (Editor) {
            ...
            var SourceEditorContextMenu = (function (_super) {
                ...
                SourceEditorContextMenu.prototype.gotoTypeDeclaration = function () {
                ...
                SourceEditorContextMenu.prototype.getInfoAt = function (type) {
                    ...
                    this.getIsense().getCrossReference(type, this.editor.filePath, this.getPos(), function (err, data) {
                        ...
                        resultTable.setData(data, _this.editor.project);
                    });
                };
                ...
                SourceEditorContextMenu.prototype.insertDoc = function () {
                    var _this = this;
                    this.getIsense().insertDocComments(this.editor.filePath, this.getPos(), function (err, data) {
                        if (data)
                            _this.editor.getAceEditor().insert(data.newText);
                    });
                };
        ...
        (function (Editor) {
            ...
            var EditSession = (function (_super) {
                ...
                function EditSession(editor) {
                    var _this = this;
                    // @TODO solve nicely
                    _super.call(this, "", "ace/mode/text");
                    this.editor = editor;
                    ...
                    _super.prototype.setMode.call(this, this.mode);
                ...
                Object.defineProperty(EditSession.prototype, "project", {
                    get: function () {
                        return Cats.IDE.getProject(this.filePath);
                    },
                    enumerable: true,
                ...
                /**
                  ...
                  *
                  */
                EditSession.prototype.isProjectCandidate = function () {
                    if (!this.filePath)
                        return false;
...
(function (Cats) {
    ...
    (function (Gui) {
        ...
        var FileNavigator = (function (_super) {
             ...
             */
            FileNavigator.prototype.setupDragAndDrop = function () {
                var _this = this;
                ...
                this.addListener("dragstart", function (e) {
                    ...
                    e.addData("tree-items", _this.getSelection());
                }, this);
                this.addListener("drop", function (e) {
                    var target = e.getOriginalTarget();
                    var itemlist = [];
                    for (var i = 0; i < _this.getSelection().getLength(); i++) {
                        itemlist.push(_this.getSelection().getItem(i));
                    }
            ...
            FileNavigator.prototype.setRootDir = function (dir) {
                var _this = this;
                this.projectDir = dir;
    ...
    (function (Gui) {
        ...
        var ResultTable = (function (_super) {
            ...
            function ResultTable(headers) {
                var _this = this;
                if (headers === void 0) { headers = ["tableheader_message", "tableheader_project", "tableheader_file", "tableheader_position"]; }
             ...
             */
            ResultTable.prototype.setData = function (data, project) {
        ...
        var MenuBar = (function () {
            ...
            MenuBar.prototype.recentProjects = function () {
                ...
                Cats.IDE.config.projects.slice().reverse().forEach(function (project) {
                    ...
                    var item = {
                        label: project,
                        click: function () { Cats.IDE.setProjectDirectory(project); }
                    };
...
(function (Cats) {
     ...
     */
    function main(app) {
        var GUI = getNWGui(); // require('nw.gui');
        ...
        if (prjDir) {
            Cats.IDE.setProjectDirectory(prjDir);
        }
        else {
